...
void Chip8::run() {
  ...
  while(!end) {
    ...
    if(event.type == SDL_KEYDOWN || event.type == SDL_KEYUP) { // If a key was pressed or released...
      ...
      case SDLK_KP_0: _KeyboardState.set(0, pressed);
        break;
      case SDLK_KP_1: _KeyboardState.set(1, pressed);
        break;
      case SDLK_KP_2: _KeyboardState.set(2, pressed);
        break;
      case SDLK_KP_3: _KeyboardState.set(3, pressed);
        break;
      case SDLK_KP_4: _KeyboardState.set(4, pressed);
        break;
      case SDLK_KP_5: _KeyboardState.set(5, pressed);
        break;
      case SDLK_KP_6: _KeyboardState.set(6, pressed);
        break;
      case SDLK_KP_7: _KeyboardState.set(7, pressed);
        break;
      case SDLK_KP_8: _KeyboardState.set(8, pressed);
        break;
      case SDLK_KP_9: _KeyboardState.set(9, pressed);
        break;
      case SDLK_a: _KeyboardState.set(0xA, pressed);
        break;
      case SDLK_b: _KeyboardState.set(0xB, pressed);
        break;
      case SDLK_c: _KeyboardState.set(0xC, pressed);
        break;
      case SDLK_d: _KeyboardState.set(0xD, pressed);
        break;
      case SDLK_e: _KeyboardState.set(0xE, pressed);
        break;
      case SDLK_f: _KeyboardState.set(0xF, pressed);
        break;
      default: break; }
...
void Chip8::_CPUThread() {
  ...
  try{
    ...
    case 8:
      switch(K) {
      case 0: _instr8XY0(X, Y);
        break;
      case 1: _instr8XY1(X, Y);
        break;
      case 2: _instr8XY2(X, Y);
        break;
      case 3: _instr8XY3(X, Y);
        break;
      case 4: _instr8XY4(X, Y);
        break;
      case 5: _instr8XY5(X, Y);
        break;
      case 6: _instr8XY6(X);
        break;
      case 7: _instr8XY7(X, Y);
        break;
      case 0xE: _instr8XYE(X);
        break; }
    case 9:
      if(!K)
        _instr9XY0(X, Y);
      break;
    case 0xA: _instrANNN(NNN);
      break;
    case 0xB: _instrBNNN(NNN);
      break;
    case 0xC: _instrCXKK(X, lowByte);
      break;
    case 0xD: _instrDXYK(X, Y, K);
      break;
    case 0xE:
      if(lowByte == 0x9E) {
        _instrEX9E(X); }
    ...
    case 0xF:
      switch(lowByte) {
      case 0x07: _instrFX07(X);
        break;
      case 0x0A: _instrFX0A(X);
        break;
      case 0x15: _instrFX15(X);
        break;
      case 0x18: _instrFX18(X);
        break;
      case 0x1E: _instrFX1E(X);
        break;
      case 0x29: _instrFX29(X);
        break;
      case 0x33: _instrFX33(X);
        break;
      case 0x55: _instrFX55(X);
        break;
      case 0x65: _instrFX65(X);
        break; }
      break;
    default:
